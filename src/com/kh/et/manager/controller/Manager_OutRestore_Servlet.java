...
@WebServlet("/outRestore.mng")
public class Manager_OutRestore_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public Manager_OutRestore_Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, 
		...
		//회원복구
		int outRestoreResult = new ManagerService().outRestoreMember(arr2);
		
		if(outRestoreResult!=0) {
