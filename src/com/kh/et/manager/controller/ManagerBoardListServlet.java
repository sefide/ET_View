...
public class ManagerBoardListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//전체 게시글 수 조회
		int listCount = ms.getListCount2();
		...
		ArrayList<HashMap<String,Object>> list=new ManagerService().boardList(currentPage,limit);
		System.out.println("리스트 가져오나");
		System.out.println(list);
		String page="";
		if(list !=null) {
			page="views/manager/board/manager_board.jsp";
