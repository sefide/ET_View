...
/*회원 탈퇴시키기*/
@WebServlet("/select06.mng")
public class Manager_Select06_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
    
    public Manager_Select06_Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, 
		...
		String page="";
		if(BlackList!=null) {
			page="views/manager/normalMember/manager_check_out.jsp";
