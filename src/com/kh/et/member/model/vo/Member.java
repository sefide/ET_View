...
public class Member implements java.io.Serializable{
	...
	public Member(int m_no, String m_id, String m_pwd, String m_name, String m_email, String m_profile, int m_point,
			...
			String m_out_status, Date m_out_date, String a_change_Name, int m_plan_num) {
		super();
		this.m_no = m_no;
		this.m_id = m_id;
		this.m_pwd = m_pwd;
	...
	public int getM_plan_num() {
		return m_plan_num;
	}


	public void setM_plan_num(int m_plan_num) {
		this.m_plan_num = m_plan_num;
	}
	...
	public String toString() {
		return "Member [m_no=" + m_no + ", m_id=" + m_id + ", m_pwd=" + m_pwd + ", m_name=" + m_name + ", m_email="
				...
				+ ", m_out_date=" + m_out_date + ", a_change_Name=" + a_change_Name + ", m_plan_num=" + m_plan_num
				+ "]";
	}
