...
/**
 * Servlet implementation class UpdateTourBoardServlet
 */
@WebServlet("/update.tbo")
public class UpdateTourBoardServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateTourBoardServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(ServletFileUpload.isMultipartContent(request)) {
			...
			int result = new TourBoardService().updateTourBoard(tb, fileList,loginUser,status,updatePhotoId);
