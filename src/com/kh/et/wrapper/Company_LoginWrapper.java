...
public class Company_LoginWrapper extends HttpServletRequestWrapper {
	
	public Company_LoginWrapper(HttpServletRequest request) {
	...
	public String getParameter(String key) {
		String value = "";
		if(key != null && key.equals("companyPwd")) {	//키 값이 companyPwd일경우
			value = getSha512(super.getParameter("companyPwd"));	//getSha512라는 메소드를 거쳐 암호화 처리를하여 반환하고,
		}else {
